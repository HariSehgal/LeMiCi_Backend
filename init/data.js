...
export const popularCRMData = {
  title: "Most Popular CRM Software",
  viewMoreLink: "/viewmore",
  viewMoreText: "View More →",
  crmList: [
    {
      id: 1,
      logo: getSoftwarePath("/zoho.jpg"),
      name: "Zoho CRM",
    ...
    {
      id: 2,
      logo: getSoftwarePath("/leadsquared.jpg"),
      name: "Lead Squared",
      rating: "(4.4 on Capterra, 4.3 on G2, & 4.4 on Gartner)",
    ...
    {
      id: 3,
      logo: getSoftwarePath("/sugarcrm.jpg"),
      name: "Sugar CRM",
    ...
    {
      id: 4,
      logo: getSoftwarePath("/salesforce.jpg"),
      name: "SaleForce",
      rating: "(4.4 on Capterra, 4.3 on G2, & 4.4 on Gartner)",
    ...
    {
      id: 5,
      logo: getSoftwarePath("/pipedrive.jpg"),
      name: "Pipedrive",
      rating: "(4.4 on Capterra, 4.3 on G2, & 4.4 on Gartner)",
    ...
    {
      id: 6,
      logo: getSoftwarePath("/hubspot.jpg"),
      name: "HubSpot",
      rating: "(4.4 on Capterra, 4.3 on G2, & 4.4 on Gartner)",
